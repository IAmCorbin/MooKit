...
/* DEFAULT LINK STYLES */
	.link { font-size: 30px; color: #0F0; background: #FF0; }
...
/* STRUCTURE */
	...
	#mainNav { margin: 10px auto 10px auto; left: 10px; top: 2px; width: 80%; border: solid red 1px; }
	#content { float: left; margin: 5% 5% 5% 5%; padding-bottom: 50px;  }
/* END STRUCTURE  */

/* CUSTOM */
	.curved, input[type="password"], input[type="text"], div.userInfo, span.linkDesc { -moz-border-radius:<?echo $curved?>; <?/* Firefox */?> -webkit-border-radius:<?echo $curved?>; <?/* Safari and chrome */?> -khtml-border-radius:<?echo $curved?>; <?/* Linux browsers */?> border-radius:<?echo $curved?>; <?/* CSS3 */?> }
